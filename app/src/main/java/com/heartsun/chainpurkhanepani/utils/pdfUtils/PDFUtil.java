package com.heartsun.chainpurkhanepani.utils.pdfUtils;
...
public class PDFUtil {
    ...
    public static void generatePDFFromHTML(final Context context, final File file, final String htmlString, final PrintAttributes.MediaSize mediaSize, PDFPrint.OnPDFPrintListener onPDFPrintListener) {
        PDFPrint.generatePDFFromHTML(context, file, htmlString,mediaSize, onPDFPrintListener);
    }
