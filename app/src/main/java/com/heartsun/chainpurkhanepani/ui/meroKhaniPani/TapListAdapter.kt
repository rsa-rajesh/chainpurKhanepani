...
import com.heartsun.chainpurkhanepani.databinding.ItemCustomerListBinding
...
class TapListAdapter(
    ...
    override fun onBindViewHolder(
        ...
        with(holder.binding) {
            tvName.text = "नाम :- " + item.MemName.toString().trim().orEmpty()
            tvMemberId.text = "दर्ता न. :- " + item.MemberID.toString().trim().orEmpty()
