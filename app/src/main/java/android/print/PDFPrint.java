...
public class PDFPrint {
    ...
    public static void generatePDFFromHTML(final Context context, final File file, final String htmlString, final PrintAttributes.MediaSize mediaSize, final OnPDFPrintListener onPDFPrintListener) {
...
//                        .setMediaSize(PrintAttributes.MediaSize.UNKNOWN_LANDSCAPE)
                        ...
                        .setResolution(new PrintAttributes.Resolution("RESOLUTION_ID", "RESOLUTION_ID", 800, 800))
                        .setMinMargins(new PrintAttributes.Margins(50,0,0,0))
                        .build();
